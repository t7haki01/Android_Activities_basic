...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        counterSet.connect(counter.getId(), ConstraintSet.TOP, guideText.getId(), ConstraintSet.BOTTOM, 10);
        counterSet.connect(counter.getId(), ConstraintSet.BOTTOM, startBtn.getId(), ConstraintSet.TOP, 10);
